...
Therefore it is straightforward for us to consider treating grouped variable `age_decades` as a mixed effect, and then we refit the multiple linear regression model above still keeping the variable `age` as a fixed effect for the sake of goodness of fit and better predictive effect of the response mean.
