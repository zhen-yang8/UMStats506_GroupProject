---
title: "Differences on Cardiovascular Health among Gender"
...
For the predictor variables, we create boxplots for each of the categorical variable. Since `age` is a continuous variable, which is hard to make a boxplot, we generate a new variable called `age_decades` which group every 10 years people into one category (i.e. divided by 10 with no remainder). 
...
|------------------------|--------|-----------|------------|
| Gender                 | -0.367 | -0.368171 | -0.358783  |
| Age                    | -0.021 | -0.019624 | -0.0207172 |
| Education              | 0.176  | 0.176018  | 0.1783475  |
| Insurance              | 0.209  | 0.211245  | 0.2110812  |
| Age (Factor)           | 0.031  | 0.04536   | 0.0424222  |
